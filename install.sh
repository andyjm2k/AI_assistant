...
echo ""
echo "[2/9] Initializing mcp-browser-use..."
...
echo ""
echo "[3/9] Creating venv and installing Python dependencies..."
...
echo ""
echo "[4/9] Installing Playwright browsers..."
...
echo ""
echo "[6/9] Setting up mcp-browser-use (uv sync + playwright)..."
...
echo ""
echo "[7/9] Creating .env and required directories..."
...
echo ""
echo "[8/9] Configuration wizard (API keys, Telegram, etc.)..."
