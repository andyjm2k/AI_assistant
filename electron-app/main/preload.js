...
contextBridge.exposeInMainWorld("catbotDesktop", {
  ...
  startActionHarness: (payload) => ipcRenderer.invoke("desktop:start-action-harness", payload),
  stopActionHarness: (reason) => ipcRenderer.invoke("desktop:stop-action-harness", reason),
  toggleActionHarness: (payload) => ipcRenderer.invoke("desktop:toggle-action-harness", payload),
  captureActionHarness: (payload) => ipcRenderer.invoke("desktop:capture-action-harness", payload),
